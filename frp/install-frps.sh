...
program_version_link="https://raw.githubusercontent.com/fmalee/VPS-Debian/master/frp/version.sh"
str_install_shell=https://raw.githubusercontent.com/fmalee/VPS-Debian/master/frp/install-frps.sh
shell_update(){
    fun_clangcn "clear"
